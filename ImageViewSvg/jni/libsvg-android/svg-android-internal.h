...
//	cairo_t cr;
	...
	jmethodID matrix_copy_constructor;
	...
	jmethodID paint_copy_constructor;
...
#define ANDROID_MATRIX_INIT(e,A,B,C,D,E,F) \
	(*(e->env))->CallStaticObjectMethod(e->env, e->raster_clazz, e->raster_matrixInit, A, B, C, D, E, F)
...
#define ANDROID_MATRIX_COPY(a,M)						\
	(*(a->env))->NewObject(a->env, a->matrix_clazz,a->matrix_copy_constructor, M)
...
#define ANDROID_PATH_CLEAR(a) \
	(*(a->env))->CallVoidMethod(a->env, a->state->path, a->path_reset)

#define ANDROID_PAINT_CREATE(a)	\
	(*(a->env))->NewObject(a->env, a->paint_clazz, a->paint_constructor)
#define ANDROID_PAINT_COPY(a,b)	\
	(*(a->env))->NewObject(a->env, a->paint_clazz, a->paint_copy_constructor, b)
